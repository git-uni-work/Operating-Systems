...
class CCustomerTest : public CCustomer
{
  public:
     ...
     */
    void Add( const std::string & destination, const CCargo & cargo );
    //---------------------------------------------------------------------------------------------
    /**
     ...
     */
    virtual void Quote( const std::string & destination, std::vector<CCargo> & cargo ) override;
  private:
...
class CShipTest : public CShip
{
  public:
     ...
     */
     CShipTest( std::string destination, int maxWeight, int maxVolume, int expected );
    //---------------------------------------------------------------------------------------------
    /**
...
class CSampleData
{
  public:
     ...
     */
     CSampleData( int expected, int maxWeight, int maxVolume, std::initializer_list<CCargo> cargo )
      : m_Expected ( expected ), m_MaxWeight ( maxWeight ), m_MaxVolume ( maxVolume ), m_Cargo ( cargo ){}
    //---------------------------------------------------------------------------------------------
    /**
     ...
     */
    AShipTest PrepareTest( std::string destination, std::vector<ACustomerTest> customers ) const;
  private:
    int m_Expected;
    int m_MaxWeight;
    int m_MaxVolume;
